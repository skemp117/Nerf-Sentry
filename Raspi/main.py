...
while True:
    ...
    get_img_time = time.perf_counter()-start_time
    ...
    input_to_model_time = time.perf_counter()-start_time
    ...
    if detections.size == 0:
        ...
        extract_results_time = time.perf_counter() - start_time 
    else:
        ...
        # print(target_params)
        find_foe_time = time.perf_counter() - start_time 
        ...
        print(f"Image: {get_img_time * 1000: 2.2f} \
                Input: {input_to_model_time * 1000: 2.2f} \
                Infer: {inference_time* 1000: 2.2f} \
                Extract: {extract_results_time* 1000: 2.2f} \
                Foe: {find_foe_time* 1000: 2.2f} \
                Draw: {draw_time* 1000: 2.2f} \
                Write: {write_time* 1000: 2.2f} \
                Total: {total_time* 1000: 2.2f}")
